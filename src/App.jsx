...
const SYSTEMS = [
  {
    id: "geocontrol",
    name: "Geocontrol",
    desc: "Gestão de topografia",
    icon: "🗺️",
    color: "#0f766e",
    external: "https://altitudetopo.vercel.app/",
  },
  {
    id: "rhcontrol",
    name: "RHControl",
    ...
    icon: "👥",
    color: "#1d4ed8",
    external: "https://rhaltitude.vercel.app/",
  },
  {
    id: "comercial",
    name: "Comercial",
    desc: "Clientes, propostas e contratos",
    icon: "💼",
    color: "#2e7d4f",
    external: null, // embutido
  },
];
...
const css = `
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  /* EMBEDDED */
  .embedded-wrap { flex: 1; overflow: hidden; }
  .embedded-wrap > div, .embedded-wrap > div > div { height: 100% !important; }
`;
        ...
        <div className="sidebar">
          <div className="logo">
            ...
            <div className="logo-text">
              ...
              <small>Central de Sistemas</small>
            </div>
          </div>

          <ul className="menu">
            <li className={active === "dashboard" ? "active" : ""} onClick={goHome}>
            ...
            {SYSTEMS.map((s) => (
              ...
              >
                <span className="menu-icon">{s.icon}</span> {s.name}
              </li>
            ))}
          </ul>
        </div>
            ...
            <>
              <div className="back-bar">
                ...
                <span className="back-title">
                  {activeSystem?.icon} {activeSystem?.name} — {activeSystem?.desc}
                </span>
              </div>
              ...
              {/* INTERNO: ComercialControl embutido */}
